...
if("TRUE" STREQUAL "TRUE")
  set(face_recognition_SOURCE_PREFIX /media/psf/TO-DO_List/ros_chatbot/chatbot_ws/src/face_recognition)
  set(face_recognition_DEVEL_PREFIX /media/psf/TO-DO_List/ros_chatbot/chatbot_ws/devel/.private/face_recognition)
  ...
  set(face_recognition_INSTALL_PREFIX /media/psf/TO-DO_List/ros_chatbot/chatbot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'face_recognition' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/media/psf/TO-DO_List/ros_chatbot/chatbot_ws/src/face_recognition/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT face_recognition_NUM_DUMMY_TARGETS)
      set(face_recognition_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::face_recognition::wrapped-linker-option${face_recognition_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR face_recognition_NUM_DUMMY_TARGETS "${face_recognition_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::face_recognition::wrapped-linker-option${face_recognition_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND face_recognition_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /media/psf/TO-DO_List/ros_chatbot/chatbot_ws/devel/.private/face_recognition/lib;/media/psf/TO-DO_List/ros_chatbot/chatbot_ws/devel/lib;/home/luigiscovotto/Desktop/Parallels Shared Folders/TO-DO_List/ros_chatbot/chatbot_ws/devel/lib;/opt/ros/noetic/lib)
...
set(face_recognition_EXPORTED_TARGETS "")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${face_recognition_dep}_FOUND)
      find_package(${face_recognition_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${face_recognition_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  ...
  _list_append_deduplicate(face_recognition_EXPORTED_TARGETS ${${face_recognition_dep}_EXPORTED_TARGETS})
endforeach()
